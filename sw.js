const CACHE='valentin-os-jarvis-v7-20260920-safe1';
const BUILD='jarvis-v7-20260920-safe1';
const ASSETS=[
  './','./index.html','./app.css?v=5',
  `./final.css?v=${BUILD}`,`./smart.css?v=${BUILD}`,`./jarvis.css?v=${BUILD}`,
  `./app.js?v=${BUILD}`,
  `./app1.js?v=${BUILD}`,`./app2.js?v=${BUILD}`,`./app3.js?v=${BUILD}`,`./app4.js?v=${BUILD}`,`./app5.js?v=${BUILD}`,`./app6.js?v=${BUILD}`,`./app7.js?v=${BUILD}`,`./app8.js?v=${BUILD}`,
